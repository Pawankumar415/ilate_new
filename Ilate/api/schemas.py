...
class CreateOrderRequest(BaseModel):
    ...
    process_first_installment_only: Optional[bool] = False  # Add this field
    

class VerifyPaymentRequest(BaseModel):
    installments_data: List[Dict[str, Any]] = []  # Correct way
...
#     code: str
#     expiry_days: Optional[int] = 2  # Default to 2 days if not passed
#     discount_rupees: Optional[int] = 0  # Default to 0
...
#     discount_multiplier: Optional[float] = None
...
class ReferralCodeCreate(BaseModel):
    code: str
    discount_rupees: Optional[int] = 0  # Default to 0
    is_enabled: bool = True  # Default to True

class ReferralCodeResponse(BaseModel):
    status: str
    message: str
    code: str
    discount_rupees: Optional[int] = None
    created_by: Optional[str] = None
    is_enabled: bool
...
class AdminInstallmentBase(BaseModel):
    number_of_installments: int
    total_amount: float
    installment_1_amount: Optional[float]
    installment_1_due_date: Optional[date]
    installment_2_amount: Optional[float]
    installment_2_due_date: Optional[date]
    installment_3_amount: Optional[float]
    installment_3_due_date: Optional[date]
...
class AdminInstallmentCreate(AdminInstallmentBase):
    pass

class AdminInstallmentResponse(AdminInstallmentBase):
    id: int
    course_id: int
...
class InstallmentResponse(BaseModel):  # Added InstallmentResponse here
    installment_id: int
    user_id: int
    payment_id: int
