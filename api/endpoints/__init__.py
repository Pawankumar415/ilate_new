...
from .Razorpay_gatway import router as razor_payment_processing
from .referal_code import router as referal_code_router
from .social_auth import router as social_auth_router
from .admin_installment import router as admin_installment_router